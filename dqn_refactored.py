...
for episode in count():
    ...
    for t in count():
        ...
        #Fetch reward and next state
        reward, next_state, scored, timeout = reward_function.UpdateAndFetchReward(timestep)
        ...
        memory.push((state, action, next_state, r, done))
        optimize_model()
